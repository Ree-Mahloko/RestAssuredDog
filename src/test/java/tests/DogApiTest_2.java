...
public class DogApiTest_2 {

    private static final String BASE_URL = "https://api.thedogapi.com";
    private static final String API_KEY = "live_HgOK0tilfFf4nopnDCXWhErGJNt1ufZTJKjAXJySkDf4PgirlRK8aFGLBgWot3iw";
    private static final String SUB_ID = "Ghost123";
    private static final String PARAM = "sub_id=" + SUB_ID;
